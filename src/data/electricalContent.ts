  ...
  "wiring-systems": {
    ...
    table: {
      ...
      rows: [
        ...
        ["Conduit (PVC/Steel)", "IP40–IP67", "Exposed runs, commercial/industrial", "Steel conduit must be earthed and also provides mechanical protection"],
  ...
  "earthing-bonding": {
    ...
    table: {
      ...
      rows: [
        ...
        ["Supplementary Bonding", "Links exposed conductive parts", "4mm² (min)", "Often omitted if all circuits are RCD protected (check latest regs)"],
