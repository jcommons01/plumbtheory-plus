const joineryContent = {
    ...
    "door-fitting": {
      ...
      table: {
        ...
        rows: [
          ...
          ["Latch Height", "From floor", "1000–1050mm", "BS 8300 for accessibility"],
    ...
    "joint-types": {
      ...
      table: {
        ...
        rows: [
          ["Mortise & Tenon", "High", "Door frames, chairs", "Traditional and durable"],
          ["Halving Joint", "Medium", "Framing, temporary joints", "Quick and simple"],
          ["Dovetail", "Very High", "Drawers, carcasses", "Strong interlocking shape"],
    ...
    "site-measurements": {
      ...
      table: {
        ...
        rows: [
          ...
          ["Template Use", "For repeat shapes", "Cardboard/MDF", "Save time on-site"],
          ["Checking Levels", "Plumb and level surfaces", "Spirit level, laser", "Prevents misalignment"]
        ]
      }
    },
    ...
    "building-regulations-joinery": {
      ...
      table: {
        ...
        rows: [
          ["Document M", "Accessible door widths", "Min 775mm clear opening", "Applies to new builds"],
          ["Fire Doors", "Fire resistance", "FD30/FD60 rated", "Must be installed with intumescent strips"],
          ["Handrail Height", "Stairs and ramps", "900–1000mm", "Both sides for public buildings"],
          ["Balustrade Gaps", "Safety", "≤100mm spacing", "Prevents child head entrapment"],
          ["Thresholds", "Max step height", "15mm max", "Level access preferred"],
          ["Glazing", "Safety glass", "Toughened/laminated", "Below 800mm from floor"]
        ]
      }
    }
  };
