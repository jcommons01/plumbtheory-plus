  ...
  <span className="text-white">{billingDate || 'Loading...'}</span>
                        ...
                        {userData?.stripeSubscriptionId && (
                          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                            ...
                            <span className="text-xs text-gray-400 font-mono break-all max-w-full sm:max-w-[200px] text-right overflow-x-auto whitespace-pre-wrap p-1 rounded bg-gray-800">
                         {userData.stripeSubscriptionId}
                            </span>
                        ...
                        <div className="border-t border-gray-600 my-6 pt-6">
                          {showCancelWarning ? (
    <div className="mb-4 p-4 bg-yellow-900 bg-opacity-70 border border-yellow-700 text-yellow-300 rounded flex flex-col sm:flex-row items-center w-full max-w-xs sm:max-w-full mx-auto text-center gap-2">
      <div className="flex items-center justify-center w-full">
        <svg className="h-6 w-6 mr-3 text-yellow-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M12 2a10 10 0 100 20 10 10 0 000-20z" /></svg>
        <span className="block w-full">Are you sure? You will lose access to Pro topics.</span>
      </div>
      <div className="flex flex-col sm:flex-row w-full justify-center items-center mt-2 sm:mt-0 gap-2">
        <button
          onClick={handleCancel}
          disabled={loading}
          className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded transition-all disabled:opacity-50 flex items-center w-full sm:w-auto justify-center"
        >
          {loading ? (
            <>
        ...
        <button
          ...
          className="text-sm text-gray-400 hover:text-white underline w-full sm:w-auto"
        >
          Nevermind
        </button>
      </div>
