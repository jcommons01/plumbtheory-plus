// ✅ COMPLETE: scripts/uploadLevel2HealthSafety.ts with 25 Level 2 questions
...
const questions = [
  // ✅ First 10 questions...
  // (...previous 10 questions from earlier update...)

  {
    id: 'level2hs11',
    topic: 'level2-health-and-safety',
...
async function uploadQuestions() {
  for (const q of questions) {
    try {
      await setDoc(doc(db, 'questions', 'level2-health-and-safety', 'items', q.id), {
        question: q.question,
        options: q.options,
