...
const electricalQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 'IPX4',
    explanation: 'Zone 1 requires a minimum of IPX4 protection to prevent water ingress.'
  },
  {
    id: 'electricalQ17',
    topic: 'electrical',
  ...
  },
  {
    id: 'electricalQ27',
    topic: 'electrical',
    question: 'What is the correct fuse rating for a 3kW electric shower?',
    options: ['16A', '32A', '13A', '40A'],
    correctAnswer: '13A',
    explanation: 'A 3kW load draws about 13A and can be safely fused with a 13A fuse.'
  },
  {
    id: 'electricalQ28',
    topic: 'electrical',
