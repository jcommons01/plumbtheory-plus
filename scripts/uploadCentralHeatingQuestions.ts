...
const centralHeatingQuestions = [
  ...
  },
  {
    ...
    topic: 'central-heating',
    question: 'Which component prevents heat being pumped into the cold feed or expansion pipe?',
    options: ['Gate valve', 'Automatic bypass valve', 'Pump overrun control', 'Pump overrun thermostat'],
    correctAnswer: 'Pump overrun thermostat',
    explanation: 'It ensures the pump runs after the boiler switches off, avoiding overheating and reverse flow.'
  },
  {
  ...
  },
  {
    ...
    topic: 'central-heating',
    question: 'Which part of a sealed heating system must include a pressure gauge?',
    options: ['Expansion vessel', 'Boiler control panel', 'Filling loop', 'Bypass circuit'],
    correctAnswer: 'Filling loop',
    explanation: 'The pressure gauge is used to monitor system pressure when topping up via the filling loop.'
  },
  {
  ...
  },
  {
    ...
    topic: 'central-heating',
    question: 'What is the recommended minimum system design temperature difference (∆T) between flow and return?',
    options: ['2°C', '5°C', '10°C', '15°C'],
    correctAnswer: '11°C',
    explanation: 'Best practice for condensing boilers is a ∆T of around 11°C to promote efficiency.'
  },
  {
  ...
  },
  {
    ...
    explanation: 'Pump flow may not reach lower radiators if balancing or circulation is poor.'
  },
  {
