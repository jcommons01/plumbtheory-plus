...
const questions = [
  ...
  },
  {
    id: 'level2common11',
    topic: 'level2-common-principles',
    question: "What happens to pressure as height increases in a water column?",
    options: ["It increases", "It decreases", "It stays the same", "It disappears"],
    correctAnswer: "It decreases",
    explanation: "Water pressure drops as the vertical height from the source increases."
  },
  {
    id: 'level2common12',
    topic: 'level2-common-principles',
  ...
  },
  {
    id: 'level2common21',
    topic: 'level2-common-principles',
    question: "What safety device is fitted on unvented hot water cylinders?",
    options: ["Stop tap", "Expansion vessel", "Check valve", "Drain cock"],
    correctAnswer: "Expansion vessel",
    explanation: "It accommodates thermal expansion to prevent pressure buildup."
  },
  {
    id: 'level2common22',
    topic: 'level2-common-principles',
