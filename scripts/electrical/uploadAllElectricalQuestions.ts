...
// ✅ Correct if this file is in: scripts/electrical/uploadAllElectricalQuestions.ts
...
if (allScripts.length === 0) {
  console.log('No Level 2 or Level 3 electrical upload scripts found.');
  process.exit(1);
}

console.log(`Running ${allScripts.length} electrical upload scripts...\n`);
