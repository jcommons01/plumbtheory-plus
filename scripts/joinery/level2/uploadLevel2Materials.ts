...
const questions = [
  {
    ...
    options: [
      ...
      "Exterior grade is always made from hardwood while interior grade uses softwood",
      "Exterior grade uses waterproof adhesives while interior grade uses moisture-resistant adhesives",
      "Exterior grade is always thicker than interior grade"
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "Solid timber compressed under high pressure",
      "Resin-bonded wood fibres",
  ...
  },
  {
    ...
    options: [
      "To accelerate the natural hardening process of freshly cut timber",
      "To create a protective barrier against UV damage",
      "To make all timber harder and more durable",
      "To strengthen softened or decayed wood by penetrating and reinforcing the wood fibres"
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "They can only be used in decorative applications",
      "Greater dimensional stability and reduced movement",
  ...
  },
  {
    ...
    options: [
      "Short lengths of timber joined together using interlocking 'fingers' to create longer pieces, providing stability and efficient use of material",
      "Timber with special grooves cut for improved grip",
      "A special timber species with naturally interlocking grain",
  ...
  },
  {
    ...
    options: [
      "They improve soundproofing only",
      "They expand when exposed to heat, sealing gaps to prevent fire and smoke spread",
      "They prevent drafts only",
      "They make the door easier to open in an emergency"
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "They are always less expensive",
      "Aesthetic reasons - they are hidden when the door is closed",
      "They provide greater closing force"
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "To make the frames more resistant to impact damage",
      "To prevent moisture transfer from masonry into timber",
  ...
  },
  {
    ...
    options: [
      "Toughened glass is always cheaper",
      "Toughened glass blocks more UV radiation",
      "Toughened glass has greater impact resistance and breaks into small cubes rather than sharp shards",
      "Toughened glass provides better thermal insulation"
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "It offers greater dimensional stability with less expansion and contraction",
      "It is always less expensive",
      "It is always made from sustainable sources"
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "Honeycomb core",
      "Lock block construction (solid timber rails and stiles with hollow centers)"
    ],
  ...
  },
  {
    ...
    options: [
      "To improve the wood's strength",
      "To prevent insects from attacking the wood",
      "To add color only",
      "To seal the timber, improve coating adhesion, and provide initial protection"
    ],
  ...
  },
  {
    ...
    options: [
      "To allow for structural movement and prevent visible cracks at material junctions",
      "To create interesting shadow effects purely for decoration",
  ...
  },
  {
    ...
    options: [
      "They penetrate deeper into the timber",
      "Lower VOC emissions, faster drying, and easier clean-up",
      "They are always more glossy",
      "They are always cheaper than oil-based products"
    ],
  ...
  },
  {
    ...
    options: [
      "They eliminate the need for a handle",
      "They are always less expensive than traditional locks",
      "They are easier to install than traditional locks",
      "They provide improved security by engaging the door at multiple points around the frame"
    ],
