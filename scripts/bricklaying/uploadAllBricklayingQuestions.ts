...
// ✅ Assumes this file is saved in: scripts/bricklaying/uploadAllBricklayingQuestions.ts
...
if (allScripts.length === 0) {
  console.log('No Level 2 or Level 3 bricklaying upload scripts found.');
  process.exit(1);
}

console.log(`Running ${allScripts.length} bricklaying upload scripts...\n`);
