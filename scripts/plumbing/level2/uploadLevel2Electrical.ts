...
const questions = [
  ...
  {
    id: 'level2elec11',
    question: "What is the minimum IP rating required for electrical equipment installed in Zone 1 of a bathroom?",
    options: ["IPX1", "IPX4", "IPX7", "IP44"],
    correctAnswer: "IPX4",
    explanation: "IPX4 is the minimum rating required in Zone 1, indicating protection against water splashes."
  },
  {
    id: 'level2elec12',
  ...
  {
    id: 'level2elec23',
    question: "What is the maximum safe voltage allowed in Zone 0 of a bathroom?",
    options: ["12V AC", "24V DC", "50V AC", "230V AC"],
    correctAnswer: "12V AC",
    explanation: "Only SELV equipment rated at 12V AC or 30V DC is permitted in Zone 0 due to high risk of water contact."
  },
  {
    id: 'level2elec24',
