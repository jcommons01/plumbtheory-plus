...
const questions = [
  {
    ...
    options: ['1–2 bar', '2–4 bar', '4–6 bar', '6–8 bar'],
    correctAnswer: '2–4 bar',
  ...
  },
  {
    id: 'level2cold7',
    topic: 'level2-cold-water',
    question: 'Which regulation governs the materials and design of domestic cold water plumbing systems?',
    options: ['Gas Safety Regulations', 'Part G of Building Regs', 'Water Supply Regs', 'Part P'],
    correctAnswer: 'Water Supply Regs',
    explanation: 'The Water Supply (Water Fittings) Regulations govern the design, materials, and installation of water systems to prevent waste, misuse, or contamination.'
  },
  {
    id: 'level2cold8',
    topic: 'level2-cold-water',
  ...
  },
  {
    id: 'level2cold20',
    topic: 'level2-cold-water',
    question: 'How should pipework be labeled when multiple water services are installed in the same area?',
    options: ['Only hot pipes are labeled', 'Label all pipes with flow arrows and colour bands', 'Cold pipes do not need labeling', 'Use red bands only'],
    correctAnswer: 'Label all pipes with flow arrows and colour bands',
    explanation: 'To ensure correct identification, all pipework should be labeled clearly, especially in commercial or multi-service installations.'
  },
  {
    id: 'level2cold21',
    topic: 'level2-cold-water',
