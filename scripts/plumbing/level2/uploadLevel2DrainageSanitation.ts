...
const questions = [
  ...
  {
    id: 'level2drain3',
    question: "Which fitting is preferred for changing direction from vertical to horizontal in a soil system?",
    options: ["Tee junction", "Straight connector", "Long radius bend", "Boss connector"],
    correctAnswer: "Long radius bend",
    explanation: "A long radius bend reduces turbulence and blockage risk where waste flow changes direction."
  },
  {
    id: 'level2drain4',
  ...
  {
    id: 'level2drain14',
    question: "Which test is commonly used to check for leaks in new soil and waste pipe installations?",
    options: ["Air test", "Polarity test", "Smoke test", "Flow test"],
    correctAnswer: "Air test",
    explanation: "Air testing is standard on new installations to check for airtightness before commissioning."
  },
  {
    id: 'level2drain15',
