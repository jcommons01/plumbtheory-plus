...
const calculationQuestions = [
  {
    ...
    correctAnswer: '2,197 kJ',
    explanation: 'Q = mcΔT → 15kg × 4.18 × 35 = 2,197.5 kJ (rounded).'
  },
  {
    id: 'calculationQ2',
    topic: 'calculation-questions',
  ...
  },
  {
    ...
    options: ['5.6 kW', '6.3 kW', '4.2 kW', '5.8 kW'],
    correctAnswer: '5.6 kW',
    explanation: 'Q = mcΔT = 120×4.18×45 = 22,572 kJ. Power = energy/time = 22,572 ÷ (30×60) = 12.5 kW, converted to kWh over 0.5h ≈ 5.6 kW.'
  },
  {
    id: 'calculationQ32',
    topic: 'calculation-questions',
