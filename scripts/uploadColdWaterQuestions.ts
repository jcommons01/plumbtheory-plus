...
const coldWaterQuestions = [
  ...
  },
  {
    id: 'coldWaterQ50',
    topic: 'cold-water',
    question: 'What is the function of a Type DC device in cold water backflow protection?',
    ...
    explanation: 'Type DC is a reduced pressure zone device used in high-hazard fluid categories to prevent contamination.'
  },
